                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"
                                                >Фактический вес (кг)</th
                                            >
                                            <th scope="col"
                                                >Фактическая влажность (%)</th
                                            >
                                            <th scope="col"
                                                >Базовая влажность (%)</th
                                            >
                                            <th scope="col"
                                                >Фактическая сорная примесь (%)</th
                                            >
                                            <th scope="col"
                                                >Базовая сорная примесь (%)</th
                                            >
                                            <th scope="col">Усушка (кг)</th>
                                            <th scope="col">Отходы (кг)</th>
                                            <th scope="col">Мех потери (кг)</th>
                                            <th scope="col"
                                                >Расчёт зачётного веса</th
                                            >
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {#each cultureFilter ? client.records.filter((c) => c.culture == cultureFilter) : client.records as record, idx (record.id)}
                                            <tr>
                                                ...
                                                <td>{record.moistureLoss}</td>
                                                <td>{record.impurityLoss}</td>
                                                <td>{record.techLoss}</td>
                                                <td>{record.result}</td>
                                            </tr>
                                        {/each}
                                    </tbody>
